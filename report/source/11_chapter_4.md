...
If the execution is still going then the behaviour of the Abstract Machine will differ based on mode's
...
The further plan is to roll out the lessons learned for more of the "Shonky" intermediate language that is
generated by Frank compiler. This will be covered in the next chapter.
