...
operator[2]={interface: {head:["aborting"], tail: null}, implementation:function(stk,env,args){try {if (args[0].tag!=="value") {throw("no match");};
env[0]=args[0].value;
...
if (args[0].command!=="aborting"){throw("no match");};
...
prog[0] = function(stk,env){return {stack:stk, comp:{tag:"value", value:{tag:"int", int:0}}}};
prog[1] = function(stk,env){return {stack:{prev: stk, frame:{ tag:"fun", env:env, args:null}}, comp:{tag:"value", value:{tag:"atom", atom:"aborting"}}}};
